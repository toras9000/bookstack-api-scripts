...
return await Paved.ProceedAsync(async () =>
{
    ...
    await foreach (var book in helper.EnumerateAllBooksAsync())
    {
        ...
        await zipFile.WriteAllBytesAsync(zip, default, signal.Token);
    }
